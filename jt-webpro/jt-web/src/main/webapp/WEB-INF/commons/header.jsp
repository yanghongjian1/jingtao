...
<div id="o-header-2013">
    <div class="w" id="header-2013">
        <div id="logo-2013" class="ld"><a href="192.168.159.144:8093/index.html" hidefocus="true"
        ...
        <div id="my360buy-2013">
            <dl>
                <dt class="ld"><s></s><a href="http://home.jd.com/"
                                         clstag="homepage|keycount|home2012|04a">我的京淘</a><b></b></dt>
                <dd>
        ...
        <div id="settleup-2013" clstag="homepage|keycount|home2013|05a">
            <dl>
                <dt class="ld"><s></s><span class="shopping"><span id="shopping-amount"></span></span>
                    <a href="http://192.168.159.144:8093/cart/show.html" id="settleup-url">去购物车结算</a>
                    <%--<a href="http://192.168.159.144:8093/cart/show.html" id="settleup-url">去购物车结算</a>--%>
                    <%--<span  id="shopping-amount1" name="shopping-amount1">去购物车结算</span>--%>
                    <b></b></dt>
                <!-- 				<dd>
                                    <div class="prompt">
                                        <div class="loading-style1"><b></b>加载中，请稍候...</div>
    ...
    <div class="w">
        <div id="nav-2013">
            ...
            <ul id="navitems-2013">
                <li class="fore1" id="nav-home" clstag="homepage|keycount|home2013|07a"><a href="192.168.159.144:8093/">首页</a>
                </li>
...
<script type="text/javascript">
    (function () {
        if (pageConfig.navId) {
            ...
            // $("#shopping-amount1").click(function(){
            // 	window.location.href="http://192.168.159.144:8093/cart/show.html";
            // });
        }
    })();
</script>