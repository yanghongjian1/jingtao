...
<div class="w w1 header clearfix">
    <div id="logo"><a href="192.168.159.144:8093/"><img clstag="clickcart|keycount|xincart|logo"
                                                        src="/images/jt-logo.png" title="返回京淘商城首页" alt="返回京淘商城首页"></a>
    </div>
        ...
        <div class="cart-inner">
                    ...
                    <div id="product_11345721" data-bind="rowid:1" class="item item_selected ">
                        <div class="item_form clearfix">
                            ...
                            <div class="cell p-goods">
                                <div class="p-img">
                                    <a href="192.168.159.144:8093/items/${cart.itemId }.html" target="_blank">
                                        <img clstag="clickcart|keycount|xincart|p-imglistcart" src="${cart.itemImage}"
                                             alt="${cart.itemTitle}" width="52" height="52">
                                    </a>
                                </div>
                                <div class="p-name">
                                    <a href="192.168.159.144:8093/items/${cart.itemId }.html"
            ...
            <div class="ui-ceilinglamp-1" style="width: 988px; height: 49px;">
              ...
              <span class="column t-checkbox form">
                  ...
                  <a href="192.168.159.144:8093/" target="_blank" clstag="clickcart|keycount|xincart|coudanlink"
                     id="continue">继续购物</a>
              </span>
                    </div>
