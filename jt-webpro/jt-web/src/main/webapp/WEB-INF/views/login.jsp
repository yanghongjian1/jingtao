...
<div class="w">
    <div id="logo">
        <a href="192.168.159.144:8093/" clstag="passport|keycount|login|01">
...
<form id="formlogin" method="post" onsubmit="return false;">
    ...
    <div class=" w1" id="entry">
                    ...
                    <div class="item-ifo">
                        ...
                        <div style="float:left;" id="ctrlDiv">
                            <input type="checkbox" class="checkbox" id="chkOpenCtrl" name="chkOpenCtrl"
                                   onclick="javascript:inputSelect();"/>
        ...
        <div class="free-regist">
            <span><a href="192.168.159.144:8093/user/register.html" clstag="passport|keycount|login|08">免费注册&gt;&gt;</a></span>
        </div>
    </div>
</form>
<div class="w1">
