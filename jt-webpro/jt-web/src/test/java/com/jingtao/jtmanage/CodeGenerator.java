...
import com.jingtao.jtmanage.constants.ProjectConstant;
...
public class CodeGenerator {
    ...
    private static final String JDBC_URL =
            "jdbc:mysql://localhost:3306/jtdb?useUnicode=true&characterEncoding=UTF-8";
    // "jdbc:mysql://10.156.14.178:3306/guanwei?useUnicode=true&characterEncoding=UTF-8";
    private static final String JDBC_USERNAME = "root";//"wotest";
    ...
    private static final String TEMPLATE_FILE_PATH =
            PROJECT_PATH + "/jt-manage/src/test/resources/generator/template"; // 模板位置

    private static final String JAVA_PATH = "/src/main/java"; // java文件路径
    private static final String RESOURCES_PATH = "/src/main/resources"; // 资源文件路径

    private static final String PACKAGE_PATH_SERVICE =
            packageConvertPath(ProjectConstant.SERVICE_PACKAGE); // 生成的Service存放路径
    private static final String PACKAGE_PATH_SERVICE_IMPL =
            packageConvertPath(ProjectConstant.SERVICE_IMPL_PACKAGE); // 生成的Service实现存放路径
    ...
    private static final String AUTHOR = "yhj"; // @author
    private static final String DATE = new SimpleDateFormat("yyyy/MM/dd").format(new Date()); // @date

    public static void main(String[] args) {
        // genCode("tbl_base_code", "BaseCodeEntity"); wx_bank_icon    OnlineInsuranceEntity
        genCode("tb_order", "Order");
